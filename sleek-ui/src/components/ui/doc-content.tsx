  ...
  return (
    <article 
      className={cn(
        ...
        "prose-h2:text-2xl prose-h2:font-semibold prose-h2:tracking-tight prose-h2:border-b prose-h2:border-border prose-h2:pb-4 prose-h2:mt-12",
        ...
        "prose-ul:my-6 prose-ul:ml-6 prose-ul:list-disc prose-ul:text-muted-foreground",
        "prose-li:my-2",
        // Code
